...
lineaccesstoken = 'lEP+AjJRWsLgR0fdI2EkLe9Je6XC51RYC3Qgjyc5uHnzYf7v8TqkeOfMq8w66IQlGYHUZZi+oZSa2cBZnw2QsaddECrwOMVCSOnCNqco8bUCYx+mmkYhSam5791E20LoitI1P5NoRBiy7Arz5FyFZQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            ...
            replyObj = TextSendMessage(text="ไม่ดีกว่า ขอบคุณนะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ตื่นยัง":
            replyObj = TextSendMessage(text="ตื่นแล้ว")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/2f433ab5-3d67-41ea-90c9-70ff0592900a"
